						...
						<div class="col-md-6 clearfix top-off">
							<div class="media">
								<div class="media-image">
									<img src="images/g11.png" class="attachment-full size-full" alt="g1">
								</div>
							...
							<div class="media">
								<div class="media-image">
									<img src="images/g22.png" class="attachment-full size-full" alt="g1">	
								</div>
								<div class="media-text">
									<h5>MAKE A GIFT</h5>
									<p>Give us a brief description of the service that you are promoting.</p>
		...
		<!-- this is footer for information -->
		<footer class="footer">
